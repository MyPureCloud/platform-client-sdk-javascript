...
Documentation version purecloud-platform-client-v2@213.1.0
...
<script type="text/javascript">
  // Obtain a reference to the platformClient object
  requirejs(['https://sdk-cdn.mypurecloud.com/javascript/amd/213.1.0/purecloud-platform-client-v2.min.js'], (platformClient) => {
