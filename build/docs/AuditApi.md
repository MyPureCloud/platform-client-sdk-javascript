...
[**postAuditsQueryRealtimeTrustorTrustorOrgId**](AuditApi.html#postAuditsQueryRealtimeTrustorTrustorOrgId) | **POST** /api/v2/audits/query/realtime/trustor/{trustorOrgId} | Get realtime audits for a trustor organization that were generated by the organization of the current user
...
<a name="postAuditsQueryRealtimeTrustorTrustorOrgId"></a>

# AuditRealtimeQueryResultsResponse postAuditsQueryRealtimeTrustorTrustorOrgId(trustorOrgId, body, opts)


POST /api/v2/audits/query/realtime/trustor/{trustorOrgId}

Get realtime audits for a trustor organization that were generated by the organization of the current user
...
apiInstance.postAuditsQueryRealtimeTrustorTrustorOrgId(trustorOrgId, body, opts)
  .then((data) => {
    console.log(`postAuditsQueryRealtimeTrustorTrustorOrgId success! data: ${JSON.stringify(data, null, 2)}`);
  })
  .catch((err) => {
    console.log('There was a failure calling postAuditsQueryRealtimeTrustorTrustorOrgId');
    console.error(err);
  });
```
