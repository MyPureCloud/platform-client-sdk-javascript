...
[**postDiagnosticsLogcaptureBrowserEntries**](LogCaptureApi.html#postDiagnosticsLogcaptureBrowserEntries) | **POST** /api/v2/diagnostics/logcapture/browser/entries | Stores log entries coming from a user for an org
[**postDiagnosticsLogcaptureBrowserEntriesDownload**](LogCaptureApi.html#postDiagnosticsLogcaptureBrowserEntriesDownload) | **POST** /api/v2/diagnostics/logcapture/browser/entries/download | Gets a link to a file with log records.
...
<a name="postDiagnosticsLogcaptureBrowserEntries"></a>

# void postDiagnosticsLogcaptureBrowserEntries(opts)


POST /api/v2/diagnostics/logcapture/browser/entries

Stores log entries coming from a user for an org
...
apiInstance.postDiagnosticsLogcaptureBrowserEntries(opts)
  .then(() => {
    console.log('postDiagnosticsLogcaptureBrowserEntries returned successfully.');
  })
  .catch((err) => {
    console.log('There was a failure calling postDiagnosticsLogcaptureBrowserEntries');
    console.error(err);
  });
```
...
<a name="postDiagnosticsLogcaptureBrowserEntriesDownload"></a>

# LogCaptureFileResponse postDiagnosticsLogcaptureBrowserEntriesDownload(opts)


POST /api/v2/diagnostics/logcapture/browser/entries/download

Gets a link to a file with log records.
...
apiInstance.postDiagnosticsLogcaptureBrowserEntriesDownload(opts)
  .then((data) => {
    console.log(`postDiagnosticsLogcaptureBrowserEntriesDownload success! data: ${JSON.stringify(data, null, 2)}`);
  })
  .catch((err) => {
    console.log('There was a failure calling postDiagnosticsLogcaptureBrowserEntriesDownload');
    console.error(err);
  });
```
