...
**/api/v2/presence/settings** (3 changes)
...
* Optional property dateLastCalculated was added
* Optional property dateLastActive was added

**Signature** (1 change)

* Optional property inclusionType was added

**EvaluationSettings** (1 change)

* Model was added

**EvaluationSettingsAssignee** (1 change)

* Model was added

**StarrableDivision** (1 change)
...
* Enum value INREVIEW was added to property status
* Enum value RETRACTED was added to property status

**EvaluationVersion** (1 change)

* Model was added

**PagelessDomainEntityListingEvaluationVersion** (1 change)

* Model was added

**SetSmsPhoneNumberActionSettings** (1 change)

* Model was added

**ApprovalNamespace** (1 change)

* Enum value users was added to property namespace
...
**PresenceSettings** (1 change)

* Model was added

**RestorePresenceSettings** (1 change)
...
* Enum value WaitForConversation was added to property uploadStatus

**WrapupCodeRequest** (1 change)

* Model was added

**WritableStarrableDivision** (1 change)

* Model was added

**LearningModuleInformStep** (1 change)

* Enum value Scorm was added to property type
...
**PUT /api/v2/outbound/digitalrulesets/{digitalRuleSetId}** (1 change)
