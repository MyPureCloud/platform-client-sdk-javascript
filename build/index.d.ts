...
declare class IdentityProviderApi {  
  	...
  	getIdentityprovidersPureengage(): Promise<Models.PureEnage>; 
  	...
  	putIdentityprovidersPureengage(body: Models.PureEnage): Promise<Models.OAuthProvider>; 
