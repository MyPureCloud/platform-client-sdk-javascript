...
declare class GamificationApi {  
  	...
  	getGamificationMetric(metricId: string): Promise<Models.Metric>; 
  	...
  	putGamificationMetric(metricId: string, body: Models.Metric): Promise<Models.Metric>; 
...
declare class LearningApi {  
  	...
  	postLearningAssignmentsBulkremove(opts?: LearningApi.postLearningAssignmentsBulkremoveOptions): Promise<void>; 
...
declare class OrganizationApi {  
  	...
  	getOrganizationsLimitsNamespaces(opts?: OrganizationApi.getOrganizationsLimitsNamespacesOptions): Promise<Models.LimitsEntityListing>; 
...
declare namespace Models { 
	...
	export interface AnalyticsEvaluation { 
		...
		"rescored"?: boolean;
		"userId"?: string;
		"getoTotalCriticalScore"?: number;
		"getoTotalScore"?: number;
	}
	...
	export interface RoutingConversationAttributes { 
		"priority"?: number;
	}
	...
	export interface WorkdayValuesMetricItem { 
		"metricDefinition"?: Models.MetricDefinition;
		"average"?: number;
		"unitType"?: string;
